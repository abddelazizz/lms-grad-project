...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    // Migrate existing chat_messages data into conversations
    // Group existing messages by sender_id + receiver_id, determine student/instructor roles
    ...
    if (existingPairs.length > 0) {
      // For each pair, figure out who is student and who is instructor
      ...
      // Map old messages to their conversation
      await queryInterface.sequelize.query(`
      ...
      // Update last_message_at for each conversation
      await queryInterface.sequelize.query(`
