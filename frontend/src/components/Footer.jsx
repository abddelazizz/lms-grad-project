        ...
        <div className="row mb-5">
          ...
          <div className="col-lg-5 mb-5 mb-lg-0">
            <div className="footer-logo mb-5">
              <img src="/images/logo.png" alt="Recode" height="70" className="d-block" />
            </div>
          ...
          <div className="col-lg-2 col-6 mb-4 mb-lg-0">
            ...
            <ul className="list-unstyled d-flex flex-column gap-3">
              <li><a href="#" className="text-secondary text-decoration-none fw-medium">Benefits</a></li>
              <li><a href="#" className="text-secondary text-decoration-none fw-medium">Our Courses</a></li>
              <li><a href="#" className="text-secondary text-decoration-none fw-medium">Our Testimonials</a></li>
              <li><a href="#" className="text-secondary text-decoration-none fw-medium">Our FAQ</a></li>
            </ul>
          </div>
          ...
          <div className="col-lg-2 col-6 mb-4 mb-lg-0">
            ...
            <ul className="list-unstyled d-flex flex-column gap-3">
              <li><a href="#" className="text-secondary text-decoration-none fw-medium">Company</a></li>
              <li><a href="#" className="text-secondary text-decoration-none fw-medium">Achievements</a></li>
              <li><a href="#" className="text-secondary text-decoration-none fw-medium">Our Goals</a></li>
            </ul>
          </div>
